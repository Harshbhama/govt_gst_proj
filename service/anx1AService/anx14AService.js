...
const anx14Dao = require("../../dao/anx1ADao/anx14ADao");
...
function getTab4details(req, res) {
  ...
  logger.log("info","Entering anx14Service.getTab4details");
    ...
    anx14Dao.getTab4adetails(gstin , rtnprd , flag)
      .then((tab4Details) =>{    
      ...
      if (_.isEmpty(req.body.ecom) || _.isEmpty(req.body.ecom) || _.isEmpty(req.body.ecom)) {
        ...
        if(validate4(req,res)){
          ...
          itemList = req.body.ecom[0].docs.map (row =>{
            ...
            let saveTab4 = await anx14Dao.saveTab4aTxn(itemList, gstin, req.headers["fp"], req.headers["rtnprd"])
  ...
  try {
    if (validateHeaders(req, res)) {
      ...
      if (_.isEmpty(req.body) || _.isEmpty(req.body.docids)) {
        ...
        let deleteTab4Data = await anx14Dao.deleteTab4aBydocidsTxn(req.body.docids, gstin, fp, rtnprd,req.headers["flag"],req.body.action)          
    ...
    if (validateHeaders(req, res) && validate4(req,res)) {
      if (_.isEmpty(req.body) || _.isEmpty(req.body.ecom[0]) || _.isEmpty(req.body.ecom[0].docs)) {
        ...
        return {
          ...
          let editTab4= await anx14Dao.editTab4aTxn(itemList, gstin, req.headers["fp"], req.headers["rtnprd"],req.headers["flag"],itemList[0].flag)
