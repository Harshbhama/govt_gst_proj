...
const anx13iDao = require("../../dao/anx1Dao/anx13iDao");
 ...
 * @param {*} res 
 */
async function getTab3idetails(req, res) {
  ...
  if (validateHeaders(req, res)) {
    ...
    let getAll3i = await anx13iDao.getTab3idetails(gstin, rtnprd ,req.headers["flag"])
 ...
 * @param {*} res
*/
function editTabtran3i(req, res) {
 ...
 * @param {*} res
*/
async function saveTab3iTxn(req, res) {
      ...
      if (_.isEmpty(req.body) || _.isEmpty(req.body.imps[0]) || _.isEmpty(req.body.imps[0].docs)) {
        ...
        if (validateItems[0] === 1) {
          ...
          if (lclpos !== doc.pos) {
            ...
            let save3i = await anx13iDao.saveTab3iTxn(tab3I, items, gstin)
 ...
 * @param {*} res
*/
async function editTab3iTxn(req, res) {
      ...
      return;
          ...
          let total_taxable_value = 0,  total_igst = 0, total_cess = 0;
            ...
            let doc = req.body.imps[0].docs[0];
              ...
              let edit3iData = await anx13iDao.editTab3iTxn(headerList, fullItemList, gstin, headerList.fp, headerList.taxPeriod, req.headers["flag"])
...
* @param {*} res
*/
async function deleteTab3iBydocidsTxn(req, res) {
  ...
  try {
    if (validateHeaders(req, res)) {
      ...
      if (_.isEmpty(req.body) || _.isEmpty(req.body.docids)) {
        ...
        let delete3iData = await anx13iDao.deleteTab3iBydocidsTxn(req.body.docids, gstin, fp, rtnprd)          
 ...
 * @param {*} res
 */
function deleteTab3iByItemIdTxn(req, res) {
  ...
  try {
    if (validateHeaders(req, res)) {
      ...
      if ( !req.body || !req.body.itemids || !Array.isArray(req.body.itemids) || _.isEmpty(req.body.itemids) ) {
        ...
        anx13iDao.deleteTab3iByItemIdTxn(req.body.itemids, req.headers["gstin"], fp, rtnprd, req.headers["flag"], req.body.status)
          .then(data => {
